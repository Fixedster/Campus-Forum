...
export default function MainLayout() {
  ...
  return (
    <div className="min-h-screen bg-base-200/50 flex flex-col">
      ...
      <footer className="bg-base-100/80 border-t border-base-200/40 py-6 mt-4">
        <div className="max-w-content mx-auto px-4">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
            <div className="flex items-center gap-2">
              ...
              <span className="font-semibold text-xs gradient-text tracking-wide">CAMPUS FORUM</span>
            </div>
            <p className="text-[11px] text-base-content/30 tracking-wide">
